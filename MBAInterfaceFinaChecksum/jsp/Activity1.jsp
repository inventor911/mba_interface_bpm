<%--  This JSP has been generated by using from xsl version 9.0 at Thu Feb 06 15:49:24 EET 2014 --%>
<!DOCTYPE html>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="ChecksumInfo"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="" dso="ChecksumInfo"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="ChecksumInfo"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="ChecksumInfo" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="ChecksumInfo"></bizsolo:executeAction>
</bizsolo:if>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.Handle Fina Checksum Diff.ChecksumInfo.label"></sbm:message></Label>
          </td>
...
var allWidgets = [{widget:'textField1', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ChecksumInfo', dataSlotType:'ABL_CHARACTER'}, target:{type:'DATASLOT', dataSlotName:'ChecksumInfo', dataSlotType:'ABL_CHARACTER'}, dsType:'ABL_CHARACTER', service:'false'}
];
var businessObjects = [];
