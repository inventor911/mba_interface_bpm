...
<%! String _PageName = "Handle Fina Checksum Diff"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="MessageQueueId,ChecksumInfo"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="MessageQueueId,ChecksumInfo" dso=""></bizsolo:executeAction>
</bizsolo:when>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:initApp mode="BizSite" name="MBAInterfaceFinaChecksum"></bizsolo:initApp>
    <bizsolo:initDS name="MessageQueueId" type="ABL_CHARACTER"></bizsolo:initDS>
    <bizsolo:initDS name="ChecksumInfo" type="ABL_CHARACTER"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="MessageQueueId,ChecksumInfo"></bizsolo:executeAction>
</bizsolo:if>

<title>Handle Fina Checksum Diff</title>
...
<input name="_PageName" type="hidden" value="Handle Fina Checksum Diff">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Handle Fina Checksum Diff.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.Handle Fina Checksum Diff.MessageQueueId.label"></sbm:message></Label>
          </td>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField2"><sbm:message key="dataslot.Handle Fina Checksum Diff.ChecksumInfo.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
...
{widget:'textField2', bound:'true', editable:'false', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ChecksumInfo', dataSlotType:'ABL_CHARACTER'}, target:{type:'DATASLOT', dataSlotName:'', dataSlotType:''}, dsType:'ABL_CHARACTER', service:'false'}
];
var businessObjects = [];
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceFinaChecksum',adapletCache:{'user':''}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
