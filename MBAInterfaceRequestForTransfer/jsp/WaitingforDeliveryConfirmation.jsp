<%--  This JSP has been generated by using from xsl version 9.0 at Wed Feb 12 12:14:57 EET 2014 --%>
<!DOCTYPE html>
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceRequestForTransfer',adapletCache:{}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
