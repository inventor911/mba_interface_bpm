<%--  This JSP has been generated by using from xsl version 9.0 at Fri Feb 14 12:08:35 EET 2014 --%>
<!DOCTYPE html>
...
<%! String _PageName = "No Acknowledged or Partial"; %>
<%! String __webAppName = "MBAInterfaceRequestForTransfer"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="MessageQueueId,RequestInfo,FullyConfirmed"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="MessageQueueId,RequestInfo,FullyConfirmed" dso=""></bizsolo:executeAction>
</bizsolo:when>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:initApp mode="BizSite" name="MBAInterfaceRequestForTransfer"></bizsolo:initApp>
    <bizsolo:initDS name="MessageQueueId" type="ABL_CHARACTER"></bizsolo:initDS>
    <bizsolo:initDS name="RequestInfo" type="ABL_CHARACTER"></bizsolo:initDS>
    <bizsolo:initDS name="FullyConfirmed" type="ABL_LOGICAL"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="MessageQueueId,RequestInfo,FullyConfirmed"></bizsolo:executeAction>
</bizsolo:if>

<title>No Acknowledged or Partial</title>
...
<% try{ %><sbm:setBundle scope="page" basename="MBAInterfaceRequestForTransfer/properties/MBAInterfaceRequestForTransfer"></sbm:setBundle><% } catch(Exception e){}%>
<bizsolo:getApplicationResources baseName="MBAInterfaceRequestForTransfer/properties/MBAInterfaceRequestForTransfer"/></head>
...
<input name="_PageName" type="hidden" value="No Acknowledged or Partial">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.No Acknowledged or Partial.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.No Acknowledged or Partial.MessageQueueId.label"></sbm:message></Label>
          </td>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField2"><sbm:message key="dataslot.No Acknowledged or Partial.RequestInfo.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
            <sfe:widget name="sbm.textfield" id="textField2" args="{'type':'text', 'size':20, 'maxlength':256, 'readonly':true, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'OpenEdge text field widget.', 'tabOrder':'0'}" />

          </td>
        </tr>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="checkbox1"><sbm:message key="dataslot.No Acknowledged or Partial.FullyConfirmed.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
            <sfe:widget name="sbm.checkbox" id="checkbox1" args="{'layout':'Vertical', 'readonly':true, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'OpenEdge Checkbox widget.', 'tabOrder':'0'}" />
...
<sbm:dataSources appName="MBAInterfaceRequestForTransfer" appType="bizlogic">
</sbm:dataSources>
<script language="JavaScript">
<!---->
</script>
...
{widget:'textField2', bound:'true', editable:'false', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'RequestInfo', dataSlotType:'ABL_CHARACTER'}, target:{type:'DATASLOT', dataSlotName:'', dataSlotType:''}, dsType:'ABL_CHARACTER', service:'false'},
{widget:'checkbox1', bound:'true', editable:'false', type:'sbm.checkbox', source: {type:'DATASLOT', dataSlotName:'FullyConfirmed', dataSlotType:'ABL_LOGICAL'}, target:{type:'DATASLOT', dataSlotName:'', dataSlotType:''}, dsType:'ABL_LOGICAL', service:'false'}
];
var businessObjects = [];
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceRequestForTransfer',adapletCache:{'user':''}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("NoAcknowledgedorPartial.jsp")%>';
