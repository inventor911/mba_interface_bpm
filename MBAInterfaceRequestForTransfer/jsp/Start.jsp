<%--  This JSP has been generated by using from xsl version 9.0 at Mon Feb 17 06:59:04 EET 2014 --%>
<!DOCTYPE html>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:initApp mode="BizSite" name="MBAInterfaceRequestForTransfer" refresh="true"></bizsolo:initApp>
...
YAHOO.util.Event.onDOMReady(function(){
  sbm.utils.setPriority('bizsite_priority','<%=com.savvion.sbm.util.PriorityHelper.self().getDefaultPriorityAsString()%>');formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceRequestForTransfer',adapletCache:{}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
