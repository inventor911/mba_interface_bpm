...
<%! String _PageName = "Missing Transactions"; %>
...
<input name="_PageName" type="hidden" value="Missing Transactions">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Missing Transactions.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("MissingTransactions.jsp")%>';
