...
<%! String _PageName = "No Acknowledged"; %>
<%! String __webAppName = "MBAInterfaceMissingTransaction"; %>
...
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="" dso="MessageQueueId"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="MessageQueueId"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="MessageQueueId" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:initApp mode="BizSite" name="MBAInterfaceMissingTransaction"></bizsolo:initApp>
    <bizsolo:initDS name="MessageQueueId" type="ABL_CHARACTER"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="MessageQueueId"></bizsolo:executeAction>
</bizsolo:if>

<title>No Acknowledged</title>
...
<% try{ %><sbm:setBundle scope="page" basename="MBAInterfaceMissingTransaction/properties/MBAInterfaceMissingTransaction"></sbm:setBundle><% } catch(Exception e){}%>
<bizsolo:getApplicationResources baseName="MBAInterfaceMissingTransaction/properties/MBAInterfaceMissingTransaction"/></head>
...
<input name="_PageName" type="hidden" value="No Acknowledged">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.No Acknowledged.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.No Acknowledged.MessageQueueId.label"></sbm:message></Label>
          </td>
...
<sbm:dataSources appName="MBAInterfaceMissingTransaction" appType="bizlogic">
</sbm:dataSources>
<script language="JavaScript">
<!---->
</script>
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceMissingTransaction',adapletCache:{'user':''}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
