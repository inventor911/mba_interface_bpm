<%--  This JSP has been generated by using from xsl version 9.0 at Fri Feb 14 09:02:18 EET 2014 --%>
<!DOCTYPE html>
...
<%! String _PageName = "No Acknowledged or Missing"; %>
...
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="MessageQueueId" dso=""></bizsolo:executeAction>
</bizsolo:when>
...
<title>No Acknowledged or Missing</title>
...
<input name="_PageName" type="hidden" value="No Acknowledged or Missing">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.No Acknowledged or Missing.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.No Acknowledged or Missing.MessageQueueId.label"></sbm:message></Label>
          </td>
