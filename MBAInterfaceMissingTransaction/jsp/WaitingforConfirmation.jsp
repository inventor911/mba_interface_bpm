<%--  This JSP has been generated by using from xsl version 9.0 at Wed Feb 12 12:14:58 EET 2014 --%>
<!DOCTYPE html>
...
<%! String _PageName = "Waiting for Missing Trans"; %>
...
<title>Waiting for Missing Trans</title>
...
<input name="_PageName" type="hidden" value="Waiting for Missing Trans">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Waiting for Missing Trans.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceMissingTransaction',adapletCache:{}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
