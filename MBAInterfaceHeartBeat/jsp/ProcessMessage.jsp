<%--  This JSP has been generated by using from xsl version 9.0 at Thu Jan 23 11:55:03 EET 2014 --%>
<!DOCTYPE html>
...
<%! String _PageName = "Processing Message"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="ProcessedAll,MessageProcessTimeout,ProcessingMessageInfo,ProcessingId"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="" dso="ProcessedAll,MessageProcessTimeout,ProcessingMessageInfo,ProcessingId"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="ProcessedAll,MessageProcessTimeout,ProcessingMessageInfo,ProcessingId"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="ProcessedAll,MessageProcessTimeout,ProcessingMessageInfo,ProcessingId" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:initDS name="ProcessedAll" type="ABL_LOGICAL"></bizsolo:initDS>
    <bizsolo:initDS name="MessageProcessTimeout" type="ABL_INT64"></bizsolo:initDS>
    <bizsolo:initDS name="ProcessingMessageInfo" type="ABL_CHARACTER"></bizsolo:initDS>
    <bizsolo:initDS name="ProcessingId" type="ABL_CHARACTER"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="ProcessedAll,MessageProcessTimeout,ProcessingMessageInfo,ProcessingId"></bizsolo:executeAction>
</bizsolo:if>
...
<input name="_PageName" type="hidden" value="Processing Message">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Processing Message.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="checkbox1"><sbm:message key="dataslot.Processing Message.ProcessedAll.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
            <sfe:widget name="sbm.checkbox" id="checkbox1" args="{'layout':'Vertical', 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'OpenEdge Checkbox widget.', 'tabOrder':'0'}" />

          </td>
        </tr>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.Processing Message.MessageProcessTimeout.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
            <sfe:widget name="sbm.textfield" id="textField1" args="{'type':'text', 'size':20, 'maxlength':50, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'integer', 'validation':{'minValue':'-9223372036854775808', 'maxValue':'9223372036854775807', 'isRequired':false, 'validateOn':['blur']}, 'type':'text', 'textfieldRequiredMsg':'Invalid Entry', 'toolTip':'OpenEdge text field widget.', 'tabOrder':'0'}" />

          </td>
        </tr>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField2"><sbm:message key="dataslot.Processing Message.ProcessingMessageInfo.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
            <sfe:widget name="sbm.textfield" id="textField2" args="{'type':'text', 'size':20, 'maxlength':256, 'readonly':false, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'OpenEdge text field widget.', 'tabOrder':'0'}" />

          </td>
        </tr>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField3"><sbm:message key="dataslot.Processing Message.ProcessingId.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
...
var allWidgets = [{widget:'checkbox1', bound:'true', editable:'true', type:'sbm.checkbox', source: {type:'DATASLOT', dataSlotName:'ProcessedAll', dataSlotType:'ABL_LOGICAL'}, target:{type:'DATASLOT', dataSlotName:'ProcessedAll', dataSlotType:'ABL_LOGICAL'}, dsType:'ABL_LOGICAL', service:'false'},
{widget:'textField1', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'MessageProcessTimeout', dataSlotType:'ABL_INT64'}, target:{type:'DATASLOT', dataSlotName:'MessageProcessTimeout', dataSlotType:'ABL_INT64'}, dsType:'ABL_INT64', service:'false'},
{widget:'textField2', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ProcessingMessageInfo', dataSlotType:'ABL_CHARACTER'}, target:{type:'DATASLOT', dataSlotName:'ProcessingMessageInfo', dataSlotType:'ABL_CHARACTER'}, dsType:'ABL_CHARACTER', service:'false'},
{widget:'textField3', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ProcessingId', dataSlotType:'ABL_CHARACTER'}, target:{type:'DATASLOT', dataSlotName:'ProcessingId', dataSlotType:'ABL_CHARACTER'}, dsType:'ABL_CHARACTER', service:'false'}
];
var businessObjects = [];
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceHeartBeat',adapletCache:{'user':''}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("ProcessMessage.jsp")%>';
