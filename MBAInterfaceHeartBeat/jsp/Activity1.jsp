<%--  This JSP has been generated by using from xsl version 9.0 at Tue Feb 04 09:35:35 EET 2014 --%>
<!DOCTYPE html>
...
<%! String _PageName = "Scheduler Error"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="SchErrorHandlingInstructions"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="ALLDATASLOTS" dso="SchErrorHandlingInstructions"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="SchErrorHandlingInstructions"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="SchErrorHandlingInstructions" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:initDS name="ALLDATASLOTS" label="ALLDATASLOTS" type="OBJECT"></bizsolo:initDS>
    <bizsolo:initDS name="SchErrorHandlingInstructions" type="ABL_CHARACTER"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="SchErrorHandlingInstructions,ALLDATASLOTS"></bizsolo:executeAction>
</bizsolo:if>

<title>Scheduler Error</title>
...
<input name="_PageName" type="hidden" value="Scheduler Error">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><bizsolo:value name="SchErrorHandlingInstructions"></bizsolo:value></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.Scheduler Error.SchErrorHandlingInstructions.label"></sbm:message></Label>
          </td>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="object01"><sbm:message key="dataslot.Scheduler Error.ALLDATASLOTS.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
            <div style="display: inline;" id="object01"><bizsolo:getDS name="ALLDATASLOTS" writePerm="false"></bizsolo:getDS>
</div>
...
var allWidgets = [{widget:'textField1', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'SchErrorHandlingInstructions', dataSlotType:'ABL_CHARACTER'}, target:{type:'DATASLOT', dataSlotName:'SchErrorHandlingInstructions', dataSlotType:'ABL_CHARACTER'}, dsType:'ABL_CHARACTER', service:'false'}
];
var businessObjects = [];
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceHeartBeat',adapletCache:{'system':'','user':''}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
