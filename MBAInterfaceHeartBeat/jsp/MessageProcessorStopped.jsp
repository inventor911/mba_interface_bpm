<%--  This JSP has been generated by using from xsl version 9.0 at Fri Feb 14 13:54:45 EET 2014 --%>
<!DOCTYPE html>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:initDS name="STARTTIME" label="STARTTIME" type="ABL_INT64"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="STARTTIME"></bizsolo:executeAction>
</bizsolo:if>
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Message Processor Stopped.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.Message Processor Stopped.STARTTIME.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
            <sfe:widget name="sbm.textfield" id="textField1" args="{'type':'text', 'size':20, 'maxlength':50, 'readonly':true, 'visible':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'OpenEdge text field widget.', 'tabOrder':'0'}" />
...
var allWidgets = [{widget:'textField1', bound:'true', editable:'false', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'STARTTIME', dataSlotType:'ABL_INT64'}, target:{type:'DATASLOT', dataSlotName:'', dataSlotType:''}, dsType:'ABL_INT64', service:'false'}
];
var businessObjects = [];
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceHeartBeat',adapletCache:{'system':''}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
