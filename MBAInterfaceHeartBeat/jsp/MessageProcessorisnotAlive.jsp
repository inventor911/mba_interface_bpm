<%--  This JSP has been generated by using from xsl version 9.0 at Fri Jan 24 14:57:07 EET 2014 --%>
<!DOCTYPE html>
...
<%! String _PageName = "Message Processor is not Alive"; %>
...
<title>Message Processor is not Alive</title>
...
<input name="_PageName" type="hidden" value="Message Processor is not Alive">
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("MessageProcessorisnotAlive.jsp")%>';
