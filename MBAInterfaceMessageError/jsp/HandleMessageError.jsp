<%--  This JSP has been generated by using from xsl version 9.0 at Wed Feb 12 16:07:44 EET 2014 --%>
<!DOCTYPE html>
...
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="MessageQueueId,MessageInfo,MessageErrors" dso=""></bizsolo:executeAction>
</bizsolo:when>
