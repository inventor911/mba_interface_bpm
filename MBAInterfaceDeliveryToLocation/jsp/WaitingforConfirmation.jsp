...
<%! String _PageName = "Waiting for Confirmation"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="MessageQueueId,DelivertyInfo"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="MessageQueueId,DelivertyInfo" dso=""></bizsolo:executeAction>
</bizsolo:when>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:initDS name="DelivertyInfo" type="ABL_CHARACTER"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="MessageQueueId,DelivertyInfo"></bizsolo:executeAction>
</bizsolo:if>
...
<input name="_PageName" type="hidden" value="Waiting for Confirmation">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Waiting for Confirmation.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField1"><sbm:message key="dataslot.Waiting for Confirmation.MessageQueueId.label"></sbm:message></Label>
          </td>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1">
            <Label class="ApSegDataslotLabel" id="" for="textField2"><sbm:message key="dataslot.Waiting for Confirmation.DelivertyInfo.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1">
...
{widget:'textField2', bound:'true', editable:'false', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'DelivertyInfo', dataSlotType:'ABL_CHARACTER'}, target:{type:'DATASLOT', dataSlotName:'', dataSlotType:''}, dsType:'ABL_CHARACTER', service:'false'}
];
var businessObjects = [];
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("WaitingforConfirmation.jsp")%>';
