<%--  This JSP has been generated by using from xsl version 9.0 at Thu Jan 30 13:19:01 EET 2014 --%>
<!DOCTYPE html>
...
<%! String _PageName = "Waiting for DeliveryConfirmation"; %>
...
<title>Waiting for DeliveryConfirmation</title>
...
<input name="_PageName" type="hidden" value="Waiting for DeliveryConfirmation">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="85%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Waiting for DeliveryConfirmation.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceDeliveryToLocation',adapletCache:{}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
