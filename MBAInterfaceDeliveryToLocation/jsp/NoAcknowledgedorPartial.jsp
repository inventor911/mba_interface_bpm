<%--  This JSP has been generated by using from xsl version 9.0 at Fri Feb 14 09:00:47 EET 2014 --%>
<!DOCTYPE html>
...
<%! String __webAppName = "MBAInterfaceDeliveryToLocation"; %>
...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="MessageQueueId,FullyConfirmed"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="MessageQueueId,FullyConfirmed" dso=""></bizsolo:executeAction>
</bizsolo:when>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:initApp mode="BizSite" name="MBAInterfaceDeliveryToLocation"></bizsolo:initApp>
    ...
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="MessageQueueId,FullyConfirmed"></bizsolo:executeAction>
</bizsolo:if>
...
<% try{ %><sbm:setBundle scope="page" basename="MBAInterfaceDeliveryToLocation/properties/MBAInterfaceDeliveryToLocation"></sbm:setBundle><% } catch(Exception e){}%>
<bizsolo:getApplicationResources baseName="MBAInterfaceDeliveryToLocation/properties/MBAInterfaceDeliveryToLocation"/></head>
...
<sbm:dataSources appName="MBAInterfaceDeliveryToLocation" appType="bizlogic">
</sbm:dataSources>
<script language="JavaScript">
<!---->
</script>
...
formWidgetHandler = new FormWidgetHandler(allWidgets,null,{processName:'MBAInterfaceDeliveryToLocation',adapletCache:{'user':''}},'<%=request.getParameter(BizSoloRequest.BSS_FIID)%>');
 });
 }
